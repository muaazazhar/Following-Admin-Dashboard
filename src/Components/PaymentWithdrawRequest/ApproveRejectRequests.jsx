      ...
      <Table >
          ...
          >
            ...
            >
              ...
              <TableCell sx={{...bodyColumnStyle, borderRight: "1px solid #e9edf4 !important", borderRadius: "0px 7px 7px 0px", width: {xs:"150px",sm:"170px",md:"180px", lg:"240px"} }}>{row.status}</TableCell>
                </TableRow>
                </>
          ))}
        </TableBody>
